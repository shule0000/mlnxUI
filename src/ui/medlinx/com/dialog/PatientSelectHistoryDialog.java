 ...
 *
 */
public class PatientSelectHistoryDialog extends JFrame {
	...
	public static void main(String[] args) {
		try {
			PatientSelectHistoryDialog dialog = new PatientSelectHistoryDialog();
	 ...
	 */
	public PatientSelectHistoryDialog( HistoryFrame mainFrame)
	{
		client = mainFrame;
		initialize();
	}
	 ...
	 * @param connectStrIn URL (String) to connect to database (get the list of online patients)
	 */
	public PatientSelectHistoryDialog(ArrayList<Patient> optionListIn, HistoryFrame mainFrame)
	{
		candidateInfoList = optionListIn;
		client = mainFrame;
		initialize();
	}
	public ArrayList<Patient> getCandidateInfoList() {
		return candidateInfoList;
	}
	public void setCandidateInfoList(ArrayList<Patient> candidateInfoList) {
	 ...
	 * constructor
	 */
	public PatientSelectHistoryDialog()
	{
		setAlwaysOnTop(true);
	...
	public void initialize() {
		...
		//framePanel = this.getContentPane();
		...
		jlayer = new JLayer<JPanel>(contentPanel, layerUI);
	    this.add(jlayer);
	    this.revalidate();
	    this.repaint();
	 ...
	 */
	public void setClient(HistoryFrame client) {
		this.client = client;
	}
